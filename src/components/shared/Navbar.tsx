        ...
        <nav className="hidden lg:block bg-gray-100 py-2">
          <div className="container flex items-center gap-8">
            ...
            <ul className="flex items-center gap-5">
              ...
              <li>
                <Link className={`${path == "/" ? "text-primary-600" : ""} hover:text-primary-600 transition-colors duration-200`} href={'/'}>Featured Products</Link>
              </li>
              <li>
                <Link className={`${path == "/" ? "text-primary-600" : ""} hover:text-primary-600 transition-colors duration-200`} href={'/'}>Offers</Link>
              </li>
              <li>
